...
| DEBT-RENDER-002-B: Bezier automation, dynamic transform, anchor and original-size semantics are blocked before execution. | active | CAP-KF-001, CAP-XFORM-001 | ACC-001, ACC-002 | Compile registered automation paths and verify curve, anchor, reframe and reopen behavior. |
...
| DEBT-RENDER-002-D: Full transition, color, graphics, variable remap, loudness and ducking scope remains blocked. | active | CAP-TIME-001, CAP-TRANS-001, CAP-COLOR-001, CAP-TEXT-001, CAP-AUDIO-001 | ACC-003, ACC-004, ACC-007, ACC-008, ACC-009, ACC-010 | Implement the specified registry operations and pass every observable media assertion. |
