...
| DEBT-RENDER-002-D: Transition source-handle execution, change-pitch/variable remap, full color, graphics, loudness and ducking scope remains blocked. | active | CAP-TIME-001, CAP-TRANS-001, CAP-COLOR-001, CAP-TEXT-001, CAP-AUDIO-001 | ACC-003, ACC-004, ACC-007, ACC-008, ACC-009, ACC-010 | Implement source-handle transitions, change-pitch and the remaining specified registry operations, then pass every observable media assertion. |
