...
新增或改变模块所有权、数据所有权、公共接口、安全边界、持久化策略、主要依赖、部署拓扑或兼容策略时必须新增 ADR。

每份 ADR 包含 Status、Context、Considered Options、Decision、Rationale、Consequences、Migration、Rollback、Date。

- [ADR-0001 Three Process Model](../decisions/ADR-0001-three-process-model.md)
- [ADR-0002 Project Host Package Ownership](../decisions/ADR-0002-project-host-package-ownership.md)
- [ADR-0003 Electron App Protocol and IPC Sender Boundary](../decisions/ADR-0003-electron-app-protocol-ipc-boundary.md)
- [ADR-0004 Worker Media Execution Boundary](../decisions/ADR-0004-worker-media-boundary.md)
- [ADR-0005 Persistent Worker Job Engine](../decisions/ADR-0005-persistent-job-engine.md)
- [ADR-0006 Atomic Edit IR CommitPlan](../decisions/ADR-0006-atomic-edit-ir-commit-plan.md)
...
- [ADR-0015 Persistent Worker and Explicit Job Recovery](../decisions/ADR-0015-persistent-worker-and-explicit-job-recovery.md)
- [ADR-0016 Unified Edit and Content Authority](../decisions/ADR-0016-unified-edit-and-content-authority.md)
- [ADR-0017 Bounded Advanced FFmpeg Execution](../decisions/ADR-0017-bounded-advanced-ffmpeg-execution.md)
- [ADR-0018 Multi-programme Governance](../decisions/ADR-0018-multi-programme-governance.md)
- [ADR-0019 Stage 2 Local Creative Context Authority](../decisions/ADR-0019-stage2-local-creative-context-authority.md)
- [ADR-0020 Creative Skill Knowledge Is Non-Executable](../decisions/ADR-0020-creative-skill-knowledge-is-non-executable.md)
