...
| First cut | Request rough cut | Compile approved intent into scoped commands | Edit Intent, Edit IR, candidate Timeline version | Host simulates and commits atomically; undo/reopen supported |
...
to edit a professional Timeline. Advanced users may open evidence, Edit IR,
