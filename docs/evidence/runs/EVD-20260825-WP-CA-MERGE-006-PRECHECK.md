---
evidence_id: EVD-20260825-WP-CA-MERGE-006-PRECHECK
date: 2026-08-25
work_package_id: WP-CA-MERGE-006
repository_commit: worktree-feedback-rejection-atomic-precheck
...
artifacts: ["post-prepare and in-transaction rejection rechecks", "controlled prepare-reject-resume interleaving", "Product and direct Host entry-point coverage", "zero execution permission, artifact, Timeline and event writes"]
...
# WP-CA-MERGE-006 precheck

The controlled interleaving test proves a rejection committed during async
preparation wins before execution permission or Timeline mutation.
