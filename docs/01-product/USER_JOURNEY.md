...
The journey is healthy when the first useful cut arrives quickly, revision
patches stay local, explanations resolve user doubt, recovery is predictable,
and ordinary projects converge within the product's revision targets without
unexplained omission. A generated file alone is not journey completion.
