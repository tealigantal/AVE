...
import { activeWorkPackages, assertProgramTopology, completedWorkPackageIds, exactWorkPackage, loadProgramModel, writeJsonFiles } from "./program-model.mjs";
import { sync } from "./sync.mjs";

export async function startWork(root, id) {
  ...
  await writeJsonFiles(root, [
    ...
    ["docs/program/PROGRAM_REGISTRY.yaml", value.registry],
  ]);
