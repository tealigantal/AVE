...
assert.equal(stage2GenerationControlState({ ...generationBase, material_authority: { status: "ambiguous", ambiguity_reason: "multiple_sufficient_material_packs", current_pack_ref: null } }).canGenerateDirections, true, "an exact material request may establish authority when no active Direction claims either sufficient Pack");
assert.deepEqual(stage2GenerationControlState({ ...generationBase, material_authority: { status: "ambiguous", ambiguity_reason: "multiple_active_material_packs", current_pack_ref: null } }), { canGenerateDirections: false, canGenerateStories: false }, "multiple active Pack authorities must not expose a Host-rejected regeneration control");
assert.deepEqual(stage2GenerationControlState({ ...generationBase, direction_authority: { status: "ambiguous", selected_direction_ref: null } }), { canGenerateDirections: false, canGenerateStories: false }, "multiple selected Direction authorities must close generation controls");
