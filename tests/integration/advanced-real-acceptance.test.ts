...
try {
  ...
  const commands: TimelineCommand[] = [
    { type: "add_clip", track_id: "main", clip: { clip_id: "opening", source: { asset_id: asset, start_pts: 0n, end_pts: s(3), timescale: scale }, timeline_start: 0n, timeline_duration: s(3) + s(1) / 2n, media_kind: "video", time_map: { map_id: "opening-ramp", pitch_policy: "preserve", segments: [
      { segment_id: "slow", timeline_start: 0n, timeline_end: s(1) + s(1) / 2n, source_start: 0n, source_end: s(1), mode: "speed", speed_numerator: 2n, speed_denominator: 3n },
      { segment_id: "normal", timeline_start: s(1) + s(1) / 2n, timeline_end: s(3) + s(1) / 2n, source_start: s(1), source_end: s(3), mode: "speed", speed_numerator: 1n, speed_denominator: 1n }
    ...
    { type: "add_clip", track_id: "main", clip: { clip_id: "closing", source: { asset_id: asset, start_pts: s(3), end_pts: s(6), timescale: scale }, timeline_start: s(2) + s(1) / 2n, timeline_duration: s(3), media_kind: "video", transform: { fit: "fill", scale_x: 1.08, scale_y: 1.08 }, grade: { grade_id: "cool-closing", brightness: -0.03, contrast: 1.08, saturation: 0.88, gamma: 0.97, context: { input_space: "rec709", working_space: "rec709", output_space: "rec709", bit_depth: 8, range: "limited" } } } },
    { type: "add_transition", track_id: "main", transition: { transition_id: "main-dissolve", kind: "cross_dissolve", from_clip_id: "opening", to_clip_id: "closing", timeline_start: s(2) + s(1) / 2n, timeline_duration: s(1) } },
    { type: "add_clip", track_id: "pip", clip: { clip_id: "moving-pip", source: { asset_id: asset, start_pts: s(1), end_pts: s(6), timescale: scale }, timeline_start: 0n, timeline_duration: s(5), media_kind: "video", transform: { scale_x: 0.34, scale_y: 0.34, x: 12, y: 84 }, mask: { mask_id: "tracked-mosaic", shape: "rectangle", mode: "mosaic", x: 0.12, y: 0.15, width: 0.3, height: 0.25, lost_frame_policy: "hold", tracking_samples: [
      { time: 0n, x: 0.12, y: 0.15, width: 0.3, height: 0.25, confidence: 0.98 },
      { time: s(5), x: 0.55, y: 0.48, width: 0.3, height: 0.25, confidence: 0.96, corrected: true }
    ] } } },
    { type: "set_automation_curve", track_id: "pip", curve: { curve_id: "pip-x", target_id: "moving-pip", property_path: "transform.x", value_kind: "number", keyframes: [
      ...
      { keyframe_id: "pip-x-end", time: s(5), value: 210, in_tangent: { time: 1, value: 80 } }
    ] } },
    { type: "set_automation_curve", track_id: "pip", curve: { curve_id: "pip-y", target_id: "moving-pip", property_path: "transform.y", value_kind: "number", keyframes: [
      ...
      { keyframe_id: "pip-y-end", time: s(5), value: 390 }
    ] } },
    { type: "add_caption", track_id: "main", caption: { caption_id: "advanced-title", text: "高级剪辑 · 真实流程", timeline_start: 0n, timeline_duration: s(5) + s(1) / 2n, language: "zh", words: [
      { text: "高级剪辑", timeline_start: s(1), timeline_duration: s(1) },
      { text: "真实流程", timeline_start: s(3), timeline_duration: s(1) }
    ] } },
    { type: "add_clip", track_id: "dialogue", clip: { clip_id: "dialogue-real", media_kind: "audio", source: { asset_id: asset, start_pts: 0n, end_pts: a(5) + a(1) / 2n, timescale: audioScale }, timeline_start: 0n, timeline_duration: s(5) + s(1) / 2n, gain_db: 1.5 } },
    { type: "set_track_properties", track_id: "dialogue", properties: { audio_routing: [{ routing_id: "dialogue-route", source_clip_id: "dialogue-real", bus: "dialogue" }] } },
    { type: "add_clip", track_id: "music", clip: { clip_id: "music-real", media_kind: "audio", source: { asset_id: asset, start_pts: a(1) / 2n, end_pts: a(6), timescale: audioScale }, timeline_start: 0n, timeline_duration: s(5) + s(1) / 2n, gain_db: -11, boundary_fades: { schema_version: 1, audio_fade_in: { value: 2n, timescale: 5n }, audio_fade_out: { value: 2n, timescale: 5n } } } },
    { type: "set_track_properties", track_id: "music", properties: { audio_routing: [{ routing_id: "music-route", source_clip_id: "music-real", bus: "music" }] } },
  ...
  for (const marker of ["xfade=transition=fade", "eval=frame:shortest=1", "crop=iw*(0.3)", "eq=brightness=0.05", "drawtext=", "fontcolor=yellow", "sidechaincompress=", "afade=t=in"]) {
